...
REGISTRY: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "table_name": "id3_buy_computer",
        "display_name": "Mua máy tính AllElectronics — 14 mẫu",
        "description": "Cùng bảng ID3 AllElectronics, dùng Naïve Bayes để dự đoán buys_computer.",
    ...
    },
    {
        ...
        "table_name": "id3_weather_play",
        "display_name": "Dự báo thời tiết chơi thể thao — 14 ngày",
        "description": "Cùng bảng ID3 thời tiết, dùng Naïve Bayes để dự đoán Play.",
        "default_config": {"laplace_alpha": 1.0, "decision_attr": "Play"},
    },
    {
        "algorithm": "naive_bayes",
        "table_name": "nb_buy_mobile",
        "display_name": "Dự đoán mua điện thoại — 14 khách hàng",
        "description": "14 khách hàng với 4 thuộc tính (tuổi, thu nhập, vùng, xếp loại tín dụng) để dự đoán hành vi mua điện thoại di động.",
    ...
    },
    {
        ...
        "description": "7 điểm phân bố trong mặt phẳng 2D, gom thành 2 cụm bằng khoảng cách Euclide từ 2 điểm khởi đầu cố định.",
        "default_config": {
            "k": 2,
            "distance": "euclidean",
            "init": "manual",
    ...
    },
    {
        ...
        "default_config": {"k": 3, "distance": "manhattan", "init": "first_k", "max_iter": 20},
    },
    {
        "algorithm": "kmeans",
    ...
    },
    {
        ...
        "default_config": {"k": 3, "distance": "euclidean", "init": "first_k", "max_iter": 20},
    },
    {
        "algorithm": "kmeans",
        ...
        "default_config": {"k": 2, "distance": "euclidean", "init": "first_k", "max_iter": 20},
    },
    {
        "algorithm": "kmeans",
        "table_name": "kmeans_2d_16pts",
        "display_name": "Tọa độ 2D — 16 điểm (k=3, Euclide)",
        "description": "16 điểm phân tán rõ thành 3 cụm tự nhiên, hội tụ nhanh sau 2 vòng lặp với trọng tâm ban đầu cố định.",
        "default_config": {
            "k": 3,
            "distance": "euclidean",
            "init": "manual",
            "centroids": [[3.8, 9.9], [7.8, 12.2], [6.2, 18.5]],
            "max_iter": 20,
        },
    },
    {
...
ALGO_FALLBACK_PARAMS: dict[str, dict[str, Any]] = {
    ...
    "rough_set": {},
    "id3": {"max_depth": 5},
    "naive_bayes": {"laplace_alpha": 1.0},
    "kmeans": {"k": 2, "distance": "euclidean", "max_iter": 20, "init": "first_k"},
}
